    ...
    <div class="container">
      ...
      <div class="row g-0">
        ...
        if (isset($_GET['nome'])) {
          ...
          $sql = "SELECT id, nome, tipo, liga, ano, preco, preco_desconto FROM camisola WHERE preco_desconto IS NOT NULL and nome='$nome' ORDER BY preco_desconto DESC";
          ...
          if ($result->num_rows > 0) {
            ...
            echo "Ainda não temos camisolas para venda da marca $nome";
          }
