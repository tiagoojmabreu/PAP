...
<body>
  ...
  <section id="EmStock" class="py-5">
    <div class="container">
      <h2 class="section__title">Em Alta Portugal</h2>
      ...
      <div class="row g-0">
        ...
        if (isset($_GET['desporto'])) {
          $desporto = $_GET['desporto'];
          ...
          $sql = "SELECT id, nome, tipo, liga, ano, preco, preco_desconto FROM camisola WHERE desporto='$desporto'  ORDER BY preco_desconto DESC";
          ...
          echo "Desporto não especificado";
        }
        ?>
      </div>
    </div>
